...
class TemperatureApp < Gtk::Application
  def initialize
    ...
    signal_connect :activate do |application|
      ...
      pocket_watch_view = PocketWatchThermometerView.new(model, controller)  # Nueva línea

      # Ensure the application stays alive as long as any window is open
      [fahrenheit_view, celsius_view, thermometer_view, pocket_watch_view].each do |view|  # Actualizado
